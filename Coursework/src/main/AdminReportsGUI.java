...
public class AdminReportsGUI extends JFrame {

    private static final long serialVersionUID = 1L;

    public AdminReportsGUI() {
    ...
    private JPanel createPlayerReportsPanel() {
        ...
        String[] columns = {"ID", "Name", "Age", "Level", "Score 1", "Score 2", "Score 3", "Score 4", "Score 5", "Overall Score"};
        ...
        try {
            String sqlCompetitors = "SELECT competitorID, firstName, lastName, age FROM competitors ORDER BY firstName, lastName";
            try (Connection conn = DBConnection.getConnection();
                ...
                while (rsComp.next()) {
                    ...
                    int age = rsComp.getInt("age");

                    String sqlScores = "SELECT level, score1, score2, score3, score4, score5 FROM score WHERE competitorID = ?";
